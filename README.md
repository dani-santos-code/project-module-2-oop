Project was deployed to Portfolio Page at https://danisantos.surge.sh/

What has been implemented:

1. The game now ends given 2 conditions: either the player kills 10 cats, or the player gets hit by a flying cat
2. Class Entity was created to make the code more DRY
3. Player can restart the game
4. There are instructions on how to play the game
5. Player can shoot mushrooms with space bar
6. Cats die
7. There is background music, a winning theme and a losing theme
8. Speed of flying cats has been decreased to make the game a bit easier to win
9. Burger can move up and down

* This is a project done for the Concordia Coding Full-Stack Bootcamp program (https://concordiabootcamps.ca/) More info on the project below:
